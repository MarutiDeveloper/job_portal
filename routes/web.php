...
Route::get('/jobs', [JobsController::class, 'showJobForm'])->name('jobs');
...
Route::group(['account'], function(){
        ...
        Route::group(['middleware'  =>  'auth'], function(){
                ...
                Route::post('/account/job/{id}/update', [AccountController::class, 'updateJob'])->name('account.updateJob');
                Route::post('/account/job/delete', [AccountController::class, 'deleteJob'])->name('account.deleteJob');

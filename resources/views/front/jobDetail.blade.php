                            ...
                            <div class="descript_wrap white-bg">
                                ...
                                <div class="pt-3 text-end">
                                        @if (Auth::check())
                                            ...
                                            @else
                                                    <a href="javascript:void(0);" class="btn btn-secondary disabled">Login For Save Job</a>
                                        @endif

                                        @if (Auth::check())
                                                    <a href="#" onclick="applyJob({{ $job->id}})" class="btn btn-primary">Apply</a>
                                                    @else
                                                    <a href="javascript:void(0);" class="btn btn-primary disabled">Login For Apply Job</a>
                                        @endif
                                ...
                                <table class="table table-striped">
                                    ...
                                    @if ($applications->isNotEmpty())
                                        ...
                                        @endforeach
                                            @else
                                            <tr>
                                                <td colspan="3"><h6 style="color: Red;">Applicants Not Found</h6></td>
                                            </tr>

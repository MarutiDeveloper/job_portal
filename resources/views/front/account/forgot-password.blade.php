            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-5">
                    <div class="card shadow border-0 p-5">
                        <h1 class="h3" style="font-family:'Times New Roman', Times, serif ;">Forgot Password</h1>
                        <form action="{{ route('account.forgotPassword') }}" method="post">
                        @csrf
                            <div class="mb-3">
                                <label for="" class="mb-2" style="font-family:'Times New Roman', Times, serif ;">Email Address*</label>
                            ...
                            <button class="btn btn-primary mt-2"  style="font-family:'Times New Roman', Times, serif ;">Submit</button>

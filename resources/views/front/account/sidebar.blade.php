<div class="card border-0 shadow mb-4 p-3">
                        ...
                        @if (Auth::user()->image != '')
                        <img src="{{ asset('profile_pic/'.Auth::user()->image) }}"  class="img-fluid rounded-circle" style="width: 150px; height: 150px;"> 
                        @else
                        <img src="{{ asset('assets/images/avatar7.png') }}" alt="avatar"  class="img-fluid rounded-circle" style="width: 150px; height: 150px;">
                        @endif     
